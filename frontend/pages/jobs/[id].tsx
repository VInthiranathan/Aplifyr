import { getAfUrl, renderApplicationInstructions, renderApplicationDeadline, renderAFDescription, renderQualifications, renderOtherInformation } from "../../components/JobAdContent";
