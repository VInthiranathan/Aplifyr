...
export default function CvPreview({ content }: { content: CvContent }) {
  ...
  return <article lang={content.language} aria-label={t('cv.preview')} className="mx-auto max-w-[210mm] min-h-[70vh] bg-white text-gray-900 shadow-sm border border-gray-200 p-6 sm:p-12 space-y-7 break-words">
